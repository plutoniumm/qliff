<script lang="ts">
  // Step controller for walking an algorithm frame by frame (decoder rounds, BP
  // iterations, contraction order). Two-way binds `value`; optional play button
  // auto-advances and stops at max.
