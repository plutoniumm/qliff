<script lang="ts">
  // Step controller for walking BP frame by frame. Two-way binds `value`;
  // optional play button auto-advances and stops at max. Self-contained local
  // copy so the BP islands do not depend on the shared prose-wrapper lib.
