...
def g(x1, z1, x2, z2):
    """
    Power of i picked up when multiplying single-qubit Paulis (x1,z1)*(x2,z2).
    """
...
def canonicalize(paulis, n):
    """
    Canonical signed-Pauli strings for the group generated by ``paulis``.
    """
...
class PauliString:
    ...
    def commutes_with(self, other):
        """
        Whether ``self`` and ``other`` commute (as Pauli operators).
        """
        s = 0
